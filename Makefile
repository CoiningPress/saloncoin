...
# Template: app
# Command: c:/QT/4.8.4/bin/qmake.exe USE_UPNP=- -o Makefile saloncoin-qt.pro
#############################################################################
...
Makefile: saloncoin-qt.pro  ../../../QT/4.8.4/mkspecs/default/qmake.conf ../../../QT/4.8.4/mkspecs/features/device_config.prf \
        ...
        $(QMAKE) USE_UPNP=- -o Makefile saloncoin-qt.pro
